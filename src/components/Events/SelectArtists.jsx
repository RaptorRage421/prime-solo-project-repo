    ...
    return (
        <div>
            ...
            <Grid container justifyContent="left" spacing={2}>
                {suggestedDJs.map((dj) => (
                    <Grid item xs={12} sm={6} md={3} lg={2} key={dj.dj_id}>
                        <Card sx={{ backgroundColor: '#1b2961' }}>
                            <CardMedia
                                component="img"
                                height="400"
                            ...
                            />
                            <CardContent>
                                <Typography sx={{ color: 'white' }} variant="h5">{dj.dj_stage_name}</Typography>
            ...
            <Grid container justifyContent="left" spacing={2}>
                {djList.map((dj) => (
                    <Grid item xs={12} sm={6} md={3} lg={2} key={dj.dj_id}>
                        <Card sx={{ backgroundColor: '#1b2961' }}>
                            <CardContent>
                                <Typography sx={{ color: 'white' }} variant="h4">{dj.dj_stage_name}</Typography>
                                <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                                    {dj.dj_genres.map((genre, index) => (
                                        <Chip
                                            key={index}
            ...
            <Stack direction="row" justifyContent="center" spacing={2} style={{ marginTop: '30px' }}>
                <Button variant="contained" size="large" onClick={createEvent}
